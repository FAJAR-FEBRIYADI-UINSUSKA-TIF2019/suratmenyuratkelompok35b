 ...
 * @category  Controller
 */
class SuratkeluarController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("suratkeluar.no_agenda", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("suratkeluar.no_agenda", $rec_id);; //select record based on primary key
		}
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("suratkeluar.no_agenda", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("suratkeluar.no_agenda", $arr_rec_id, "in");
