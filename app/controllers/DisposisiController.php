...
class DisposisiController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				disposisi.agenda_surat_masuk LIKE ? OR 
				disposisi.tujuan LIKE ? OR 
				disposisi.isi LIKE ? OR 
				disposisi.batas_waktu LIKE ? OR 
				disposisi.sifat_surat LIKE ? OR 
				disposisi.catatan LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("agenda_surat_masuk","tujuan","isi","batas_waktu","sifat_surat","catatan");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'agenda_surat_masuk' => 'required',
				'tujuan' => 'required',
				'isi' => 'required',
			...
			$this->sanitize_array = array(
				'agenda_surat_masuk' => 'sanitize_string',
				'tujuan' => 'sanitize_string',
				'isi' => 'sanitize_string',
				'batas_waktu' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_disposisi","agenda_surat_masuk","tujuan","isi","batas_waktu","sifat_surat","catatan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'agenda_surat_masuk' => 'required',
