                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-isi"  value="<?php  echo $data['isi']; ?>" type="text" placeholder="Enter Isi"  required="" name="isi"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
