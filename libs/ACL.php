...
class ACL
{
	...
	public static $role_pages = array(
			'kepsek' =>
						array(
							'legalisir' => array('list','view'),
							'suratkeluar' => array('list','view'),
							'suratmasuk' => array('list','view'),
							'disposisi' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
			...
			'kepala' =>
						array(
							...
							'suratkeluar' => array('list','view'),
							'suratmasuk' => array('list','view'),
							'pengguna' => array('list','view','accountedit','accountview','add','edit', 'editfield','delete','import_data'),
							'disposisi' => array('list','view','add','edit', 'editfield','delete','import_data')
						),
		
			'staf' =>
						array(
							'legalisir' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'suratkeluar' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'suratmasuk' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'disposisi' => array('list','view')
						),
